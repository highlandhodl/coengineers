...
Some labs integrate with external APIs. All have free tiers available.
...
You don't need accounts for these right now. We'll tell you exactly what you need at the start of each lab.
