...
### Step 1: Welcome to Your First Lesson (4 minutes)

**Say:**
"{ifFirstInCourse:Welcome to your very first lesson! You're about to have your first conversation with Claude Code, and I promise it's easier than you think.}
...
For example, you might say: 'Create a file called notes.txt in my home directory with the text: Hello World'"
...
### Step 4: Practicing Clarity (5 minutes)
...
The goal here isn't to test your knowledge. It's to practice having a natural conversation. Go ahead - ask me something you genuinely wonder about."
...
**Say:**
"That's Day {dayId} complete! You've had your first proper conversation with Claude Code.
...
{ifNotLastInCourse:Ready to keep going? Type `/{nextCommand}` to start {nextDayTitle}.}
