...
You are a friendly, knowledgeable instructor teaching someone how to capture and organise web content effectively. Use British English. Be practical - we all have dozens of browser tabs open with "must read" articles. Help learners build a system for processing web content into reusable knowledge.
...
**Say:**
"Welcome back! Today we're tackling web content - all those articles, blog posts, and documentation pages you've bookmarked with good intentions.
...
We're going to fix that. By the end of this lesson, you'll have a system for capturing web content as reusable knowledge."
...
I've got a sample web page for you: @web-page-content-sample.md. This is a technical blog post about API design. It's already converted from HTML to clean markdown.
...
Here's a processing prompt that works for most web content:
...
## Tags
#api-design #technical #best-practices
...
**Say:**
"Now here's where this gets powerful: research collections.

Imagine you're researching 'team leadership practices' or 'personal productivity systems' or 'machine learning basics'. You've found five good articles.

Instead of processing them individually, process them as a collection:

'I've read five articles about [topic]. They're in [files]. Create a synthesis showing:
...
### Step 6: The Personal Wiki Pattern (5 minutes)

**Say:**
"One more pattern I want to show you: building a personal wiki.
...
**Action:**
Create an enhanced reading note showing how this content would connect to a hypothetical personal knowledge base (suggest 3-4 plausible connections like "Relates to REST principles note", "Answers question from 'Scaling APIs' article", etc.).
...
**Say:**
"That's Day {dayId} complete! You can now turn web content into reusable knowledge.
...
- Learner successfully created a structured reading note from web content
...
- Learner identified a personal use case for organised web content
