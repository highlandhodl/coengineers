...
By the end of this lesson, you'll turn any video transcript into structured learning notes."
...
I've got a sample YouTube transcript for you: @youtube-transcript-sample.md. This is from a 42-minute talk on product development.
...
Let's practise with the conference talk transcript we just processed. This time, ask me to extract it specifically as a conference talk summary. Include: research findings mentioned, data/statistics shared, and novel ideas presented."

**Check:** Wait for learner to write their prompt

**Action:**
Process the transcript again with the conference-focused lens. Show how different the output structure is when optimised for that content type.
...
'Analyse @youtube-transcript-sample.md and create a jump-to guide with timestamps for: key concept introductions, actionable examples, and important data/research. For each, include the timestamp and a one-line description of what happens at that moment.'"

**Check:** Wait for learner to request the timestamp extraction

**Action:**
Create a jump-to guide with timestamps (if available in the transcript) showing key moments worth watching.
...
Imagine you've got three videos about, say, pricing strategy. Instead of watching all three (90+ minutes), you could process all three transcripts and ask:
...
Think about a topic you've been meaning to research. Maybe 'delegation techniques' or 'time management' or 'public speaking tips'. Tell me what topic, and imagine you had three video transcripts on it - what would you want to compare?"
...
**Say:**
"That's Day {dayId} complete! You can now extract insights from video content at speed.
