# Theme 2, Lab 2: Audio Transcript Processing
...
**Say:**
"Welcome back! In the previous lab, we cleaned up meeting notes. Today we're tackling something even messier: voice transcriptions.
...
By the end of this lab, you'll turn rambling voice notes into crisp, readable content."
...
- @voice-memo-transcript-2.md (Technical bug investigation)
...
Now your turn: Process the second transcript (@voice-memo-transcript-2.md). This one's a technical bug investigation, so think about what structure would be useful. Technical notes typically want: the problem, the investigation steps, and the solution."
...
Which level do you think works best for the technical bug investigation you just processed?"
...
{ifNotLastInCourse:Keep going - there's more to learn.}
