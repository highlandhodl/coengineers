      ...
      sidebar: [
        {
          ...
          collapsed: true,
          items: [
            { label: 'The Lie I Believed', slug: 'blog/01-my-ai-story' },
            { label: 'The Day I Wasted', slug: 'blog/02-thoughts-on-genai' },
            { label: 'Built With What It Teaches', slug: 'blog/03-built-with-what-it-teaches' },
            ...
            { label: "Who It's For", slug: 'blog/05-who-this-course-is-for' },
            {
              ...
              slug: 'blog/06-why-this-course-is-different',
