# Day 24: The User Story - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w4.d24" → Day ID: "4.24"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "4.24"

3. Get the teaching script path from the config: `lesson-modules/week-4/day-24-the-user-story/CLAUDE.md`
