# Day 30: PRP Framework - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "bonus.d30" → Day ID: "bonus.30"
   - Pattern: bonus.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "bonus.30"

3. Get the teaching script path from the config: `lesson-modules/bonus/day-30-prp-framework/CLAUDE.md`
