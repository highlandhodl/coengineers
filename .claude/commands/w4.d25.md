# Day 25: Code the Story - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w4.d25" → Day ID: "4.25"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "4.25"

3. Get the teaching script path from the config: `lesson-modules/week-4/day-25-code-the-story/CLAUDE.md`
