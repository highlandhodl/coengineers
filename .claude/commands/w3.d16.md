# Day 16: Image Prompter - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w3.d16" → Day ID: "3.16"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "3.16"

3. Get the teaching script path from the config: `lesson-modules/week-3/day-16-image-prompter/CLAUDE.md`
