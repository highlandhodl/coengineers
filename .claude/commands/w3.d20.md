# Day 20: Video Brief Creator - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w3.d20" → Day ID: "3.20"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "3.20"

3. Get the teaching script path from the config: `lesson-modules/week-3/day-20-video-brief-creator/CLAUDE.md`
