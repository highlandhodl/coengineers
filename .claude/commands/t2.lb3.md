# Lab 3: Email Refinement to Obsidian - Lesson Launcher
...
3. Get the teaching script path from the config: `lesson-modules/theme-2/lab-3-email-refinement/CLAUDE.md`
