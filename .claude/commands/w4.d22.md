# Day 22: The Product Idea - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w4.d22" → Day ID: "4.22"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "4.22"

3. Get the teaching script path from the config: `lesson-modules/week-4/day-22-the-product-idea/CLAUDE.md`
