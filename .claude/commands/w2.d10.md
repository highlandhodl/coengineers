# Day 10: YouTube Brain - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w2.d10" → Day ID: "2.10"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "2.10"

3. Get the teaching script path from the config: `lesson-modules/week-2/day-10-youtube-brain/CLAUDE.md`
