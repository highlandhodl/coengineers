# Day 31: Ship It! Capstone - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "bonus.d31" → Day ID: "bonus.31"
   - Pattern: bonus.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "bonus.31"

3. Get the teaching script path from the config: `lesson-modules/bonus/day-31-ship-it/CLAUDE.md`
