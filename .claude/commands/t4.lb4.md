# Lab 4: PRD Creation - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract theme/lab ID:
   - Command name: "t4.lb4" → Theme ID: "4", Lab ID: "4"
   - Pattern: t{theme}.lb{lab}

2. Read `.claude/course-structure.json` to find the lab with ID "4.4"

3. Get the teaching script path from the config: `lesson-modules/theme-4/lab-4-prd-creation/CLAUDE.md`
