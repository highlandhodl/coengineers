# Day 29: BMAD Method - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "bonus.d29" → Day ID: "bonus.29"
   - Pattern: bonus.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "bonus.29"

3. Get the teaching script path from the config: `lesson-modules/bonus/day-29-bmad-method/CLAUDE.md`
