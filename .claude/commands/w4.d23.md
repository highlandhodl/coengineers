# Day 23: The Product Backlog - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w4.d23" → Day ID: "4.23"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "4.23"

3. Get the teaching script path from the config: `lesson-modules/week-4/day-23-the-product-backlog/CLAUDE.md`
