# Day 15: Presentation Builder - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w3.d15" → Day ID: "3.15"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "3.15"

3. Get the teaching script path from the config: `lesson-modules/week-3/day-15-presentation-builder/CLAUDE.md`
