# Day 13: Email Processor - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w2.d13" → Day ID: "2.13"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "2.13"

3. Get the teaching script path from the config: `lesson-modules/week-2/day-13-email-processor/CLAUDE.md`
