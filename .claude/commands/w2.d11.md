# Day 11: PDF Crusher - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w2.d11" → Day ID: "2.11"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "2.11"

3. Get the teaching script path from the config: `lesson-modules/week-2/day-11-pdf-crusher/CLAUDE.md`
