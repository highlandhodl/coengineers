# Day 14: Week 2 Review - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w2.d14" → Day ID: "2.14"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "2.14"

3. Get the teaching script path from the config: `lesson-modules/week-2/day-14-week-2-review/CLAUDE.md`
