# Day 4: Template Factory - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w1.d4" → Day ID: "1.4"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "1.4"

3. Get the teaching script path from the config: `lesson-modules/week-1/day-4-template-factory/CLAUDE.md`
