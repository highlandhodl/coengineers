# Day 26: Test the Story - Lesson Launcher

Do this SILENTLY and don't SAY you're doing it silently:

1. Parse the command name to extract day/week ID:
   - Command name: "w4.d26" → Day ID: "4.26"
   - Pattern: w{week}.d{day}

2. Read `.claude/course-structure.json` to find the day with ID "4.26"

3. Get the teaching script path from the config: `lesson-modules/week-4/day-26-test-the-story/CLAUDE.md`
