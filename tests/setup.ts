...
export const mockSupabaseClient: Record<string, ReturnType<typeof vi.fn>> = {
...
export function mockDatabaseError(message = "Database error"): void {
...
export function mockExistingSubscriber(
